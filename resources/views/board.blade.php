...
<p class="w-100 text-center mt-4">
  <a class="add-fen w-25 btn btn-dark btn-lg" href="{{ url('/ban-co') }}"><i class="fad fa-save"></i> Lưu bàn cờ</a>
</p>
<p class="w-100 text-center mt-4">
  <a id="switch" class="w-25 btn btn-dark btn-lg"><i class="fad fa-chess-board"></i> Đổi bên</a>
  <a id="undo" class="w-25 btn btn-danger btn-lg"><i class="fad fa-undo"></i> Đi lại</a>
</p>
