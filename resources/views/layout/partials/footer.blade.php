  ...
  <div class="container">
    <div class="row p-5">
      <div class="col-12 col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3 vcard">
        ...
        <p class="mt-3"><i class="fad fa-copyright"></i> Bản quyền <a class="url fn h-card" target="_blank" href="https://tungpham42.info/">Phạm Tùng</a></p>
      </div>
      <div class="col-12 col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3">
        <ul class="list-unstyled">
          <li>
            <a class="home" href="{{ url('/') }}"><i class="fad fa-home-lg-alt"></i> Trang chủ</a>
          </li>
          <li>
            <a class="room" href="{{ url('/danh-sach-phong') }}"><i class="fad fa-th-list"></i> Danh sách phòng</a>
          </li>
          <li>
            <a class="setup" href="{{ url('/co-the') }}"><i class="fad fa-camera-retro"></i> Cờ thế</a>
          </li>
          <li>
            <a class="about" href="{{ url('/gioi-thieu') }}"><i class="fad fa-info-square"></i> Giới thiệu</a>
          </li>
          <li>
            <a class="contact" href="{{ url('/lien-he') }}"><i class="fad fa-envelope"></i> Liên hệ</a>
          </li>
          <li>
            <a class="lang" href="{{ url($langUrl) }}"><i class="fad fa-language"></i> English</a>
          </li>
          <li>
