...
<p class="w-100 text-center mt-4">
  <a id="red-link" class="w-25 btn btn-danger btn-lg" href="{{ url('/') }}/phong/{{ $roomCode }}/do"><i class="fad fa-chess-clock-alt"></i> Bên ĐỎ</a>
  <a id="black-link" class="w-25 btn btn-dark btn-lg" href="{{ url('/') }}/phong/{{ $roomCode }}/den"><i class="fad fa-chess-clock"></i> Bên ĐEN</a>
</p>
<script>
