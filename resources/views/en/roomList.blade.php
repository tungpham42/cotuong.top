...
<div class="container-fluid game px-0">
  ...
  @for ($i = 0; $i < count($rooms); ++$i)
          <tr>
            <td class="text-center room-code"><a href="{{ url('/') }}/room/{{ $rooms[$i]['code'] }}">{{ $rooms[$i]['code'] }}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-key text-danger" data-toggle="tooltip" data-placement="bottom" data-original-title="{{ $rooms[$i]['pass'] }}"></i></td>
            ...
            <td class="text-center" data-sort-method="none"><a target="_blank" class="btn btn-success" href="{{ url('/board/') }}/{{ $rooms[$i]['fen'] }}">View</a></td>
