...
<p class="w-100 text-center mt-4">
  <a id="red-link" class="w-25 btn btn-danger btn-lg" href="{{ url('/') }}/room/{{ $roomCode }}/red"><i class="fad fa-chess-clock-alt"></i> RED side</a>
  <a id="black-link" class="w-25 btn btn-dark btn-lg" href="{{ url('/') }}/room/{{ $roomCode }}/black"><i class="fad fa-chess-clock"></i> BLACK side</a>
</p>
<script>
...
window.onload = function(){
  if (board.orientation() == 'black' && game.turn() === 'r') {
    location.href = $('#red-link').attr('href');
  }
};
